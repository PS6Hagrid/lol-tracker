const features = [
  {
    title: "Match History",
    description: "Detailed breakdowns with damage, vision, builds, and gold graphs for every game.",
    icon: (
  ...
  {
    title: "Live Game",
    description: "See who's in-game right now with ranks, winrates, and champion picks.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Track mastery levels, points, and most-played champions at a glance.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Gold advantage charts and key events minute-by-minute for deep analysis.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
