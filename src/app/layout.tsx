      ...
      <body className={`${inter.variable} bg-bg-page text-text-primary overflow-x-hidden antialiased`}>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-700/50 bg-bg-page/95 backdrop-blur-md sm:hidden" role="navigation" aria-label="Mobile navigation">
          <div className="flex items-center justify-around py-2">
            ...
            <Link href="/champions" className="flex flex-col items-center gap-0.5 px-3 py-1 text-gray-400 transition-colors hover:text-white">
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <Link href="/patch-notes" className="flex flex-col items-center gap-0.5 px-3 py-1 text-gray-400 transition-colors hover:text-white">
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
